...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/15 04:29:51 by ide-dieg          #+#    #+#             */
/*   Updated: 2024/12/15 05:28:53 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
	...
	patrolling(map_xy, guardians, file->lines, 8000);
	...
	while(0 == 0)
	{
		patrolling(map_xy, guardians, file->lines, 1);
		print_map(map_xy, guardians, file->lines);
		ft_printf("\nTime: %d\n\n", time);
		time++;
		usleep(200000);
